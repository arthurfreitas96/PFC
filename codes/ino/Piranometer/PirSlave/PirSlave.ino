...
void requestEvent()
{
    ...
    if(2.75 < v1 && v1 < 4.76){
      output = 47.5*pow(v1,2) - 4.4*pow(10,2)*v1 + 1048; 
    }
    else if(0.38 < v2 && v2 < 0.61){
      output = 5.5*pow(10,3)*pow(v2,2) - 6.3*pow(10,3)*v2 + 2*pow(10,3);
    }
    else if(0.32 < v2 && v2 < 0.39){
      output = 1.93*pow(10,4)*pow(v2,2) - 1.7*pow(10,4)*v2 + 4*pow(10,3);
    }
    else if(0.29 < v2 && v2 < 0.33){
      output = 4.5*pow(10,4)*pow(v2,2) - 3.3*pow(10,4)*v2 + 6.5*pow(10,3);
    }
    else if(0.37 < v3 && v3 < 0.42){
      output = 4.8*pow(10,4)*pow(v3,2) - 4.2*pow(10,4)*v3 + 9999.7;
    }
    else output = 0;
